...
public class CommonPermissionActivity extends AppCompatActivity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.common_activity_permission);
    ...
    public void onClick(View view) {
        ...
        if (viewId == R.id.btn_main_request_1) {
            ...
            view.postDelayed(new Runnable() {
                ...
                @Override
                public void run() {
                    XXPermissions.with(CommonPermissionActivity.this)
