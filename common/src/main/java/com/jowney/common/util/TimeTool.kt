...
import com.jowney.common.util.ConstantsTool.DAY
import com.jowney.common.util.ConstantsTool.HOUR
import com.jowney.common.util.ConstantsTool.MIN
import com.jowney.common.util.ConstantsTool.MSEC
import com.jowney.common.util.ConstantsTool.SEC
import com.jowney.common.util.DataTool.Companion.isNullString
import com.jowney.common.util.DataTool.Companion.stringToInt
...
object TimeTool {
     ...
     */
    val DEFAULT_SDF = SimpleDateFormat(ConstantsTool.DATE_FORMAT_DETACH, Locale.getDefault())
    /**
     * 将时间戳转为时间字符串
     *
     * 格式为用户自定义
     ...
     */
    @JvmStatic
    fun milliseconds2Unit(milliseconds: Long, unit: ConstantsTool.TimeUnit?): Long {
        when (unit) {
            ConstantsTool.TimeUnit.MSEC -> return milliseconds / MSEC
            ConstantsTool.TimeUnit.SEC -> return milliseconds / SEC
            ConstantsTool.TimeUnit.MIN -> return milliseconds / MIN
            ConstantsTool.TimeUnit.HOUR -> return milliseconds / HOUR
            ConstantsTool.TimeUnit.DAY -> return milliseconds / DAY
            else -> {
            }
        }
        return -1
     ...
     */
    @JvmStatic
    fun getIntervalTime(time0: String?, time1: String?, unit: ConstantsTool.TimeUnit?): Long {
     ...
     */
    @JvmStatic
    fun getIntervalTime(time0: String?, time1: String?, unit: ConstantsTool.TimeUnit?, format: SimpleDateFormat): Long {
     ...
     */
    @JvmStatic
    fun getIntervalTime(time1: Date, time2: Date, unit: ConstantsTool.TimeUnit?): Long {
     ...
     */
    @JvmStatic
    fun getIntervalByNow(time: String?, unit: ConstantsTool.TimeUnit?): Long {
     ...
     */
    @JvmStatic
    fun getIntervalByNow(time: String?, unit: ConstantsTool.TimeUnit?, format: SimpleDateFormat): Long {
     ...
     */
    @JvmStatic
    fun getIntervalByNow(time: Date, unit: ConstantsTool.TimeUnit?): Long {
    ...
    fun simpleDateFormat(format: String?, date: Date?): String {
        ...
        if (isNullString(format)) {
            format = ConstantsTool.DATE_FORMAT_DETACH_SSS
        }
    ...
    fun formatTime(milliseconds: Long): String {
        val format = ConstantsTool.DATE_FORMAT_MM_SS
