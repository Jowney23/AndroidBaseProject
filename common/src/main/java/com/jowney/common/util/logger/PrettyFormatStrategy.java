...
public class PrettyFormatStrategy implements FormatStrategy {
     ...
     * Drawing toolbox
     */
    private static final char TOP_LEFT_CORNER = '┌';//数据开始分隔符
    private static final char BOTTOM_LEFT_CORNER = '└';//同一条Log数据结束分隔符
    private static final char MIDDLE_CORNER = '├';
    private static final char HORIZONTAL_LINE = '│';
    private static final String DOUBLE_DIVIDER = "────────────────────────────────────────────────────────";
    private static final String SINGLE_DIVIDER = "";//修改建议，同一条Log数据中间不搞长线分割
